            ...
            <div className="bg-[var(--background-secondary)] shadow-md rounded-lg p-6">
                ...
                <form onSubmit={handleGeneralSettingsSubmit} className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-[var(--border-primary)]">
                        <label className="flex items-center justify-between cursor-pointer">
                            <div>
                                <h3 className="text-lg font-semibold text-[var(--text-secondary)]">Importación Automática WooCommerce</h3>
                    ...
                    <div className="pt-4 border-t border-[var(--border-primary)]">
                        <label className="flex items-center justify-between cursor-pointer">
                            <div>
                                <h3 className="text-lg font-semibold text-[var(--text-secondary)]">Habilitar Selección Múltiple y Cierre Masivo para Conductores</h3>
                    ...
                    {auth?.user?.email === 'admin' && (
                        <div className="pt-4 border-t border-[var(--border-primary)]">
                            <label className="flex items-center justify-between cursor-pointer">
                                <div>
                                    <h3 className="text-lg font-semibold text-[var(--text-secondary)]">Alertar Pagos Pendientes a Administradores</h3>
